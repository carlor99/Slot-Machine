...
public class SlotFrame extends JFrame {
	...
	public SlotFrame() {
		...
		lblTentativi.setBounds(325, 350, 28, 28);
		...
		lblPercVincite.setBounds(490, 364, 80, 28);
		contentPane.add(lblPercVincite);
		

		JButton btnNew = new JButton("Gioca!");
		...
		btnNew.setBounds(286, 241, 185, 52);
		...
		btnChiudi.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				CreditsFrame creditsFrame = new CreditsFrame(test.getTentativi(),test.getVincite());
				creditsFrame.setVisible(true);
				dispose();
			}
		});
		btnChiudi.setBounds(658, 401, 103, 28);
